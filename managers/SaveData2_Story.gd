extends Resource
class_name SaveDataTwoResource
...
@export var data_dic = {
	...
	"currentlives": SaveFileManager2.currentplayerlives,
	"currentlivest": SaveFileManager2.currentplayerlivest,
	"maxlives": SaveFileManager2.maxcurrentlives,
	"trianglestotal": SaveFileManager2.trianglestotal,
	"trianglestotalt": SaveFileManager2.trianglestotalt,
	"trianglestotalh": SaveFileManager2.trianglestotalh,
	"maxtriangles": SaveFileManager2.maxtrianglestotal
	}

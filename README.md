# Shimeji Adventure - Official Source Code
...
You can go through up to 10 levels (2 of which are only available in Freeplay Mode), and even go through a short Story Mode (though it'll get longer as the game's update goes by).
...
* You'll need Godot Engine 4.5.1 + to load the game's project file.
